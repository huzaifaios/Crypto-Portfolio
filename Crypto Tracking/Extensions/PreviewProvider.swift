...
class PreviewData {
    ...
    let stat1 = StatisticModel(title: "MarketCap", value: "$1.2Bn", percentageChange: 5.34)
    let stat2 = StatisticModel(title: "MarketCap", value: "$1.3Tr")
    let stat3 = StatisticModel(title: "MarketCap", value: "$1.65K", percentageChange: -5.8)
